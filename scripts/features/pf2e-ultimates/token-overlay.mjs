...
/* The vertex shader and the UV-scale prelude are shared suite-wide; they live
   in core/glsl.mjs and are re-exported here so this module stays the single
   import site for everything this overlay compiles. */
export { VERTEX_SHADER, SCALE_PRELUDE } from "../../core/glsl.mjs";
import { SCALE_PRELUDE } from "../../core/glsl.mjs";
