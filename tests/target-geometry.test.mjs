...
import {
  ...
  pointAt,
  ringRadius
} from "../scripts/features/stream-targets/targeting/target-geometry.js";
...
test("the geometry module is pure", () => {
  const code = readFileSync(new URL("../scripts/features/stream-targets/targeting/target-geometry.js", import.meta.url), "utf8")
    .replace(/\/\*[\s\S]*?\*\//g, "")
    .replace(/\/\/.*$/gm, "");
